...
export class FaucetTransactions extends BaseElement {
	...
	static get styles(){
		return css`
			...
			.headers :nth-child(1) { width: var(--value-column-width); text-align:center; }
			.headers :nth-child(2) { width: var(--blue-score-column-width); text-align:center; }
			.headers :nth-child(3) { width: var(--txid-column-width); }
